...
打开 Claude Code（或任意 AI 编程工具），复制下面这句话：

> 阅读 https://github.com/JIANGXIADADAO/dailyscan 的 README.md 和 SKILL.md，帮我在本地一步步部署 dailyscan，装好依赖、注册各平台账号、登录保存 cookie、配置 Skill，每完成一步向我确认后再继续。
